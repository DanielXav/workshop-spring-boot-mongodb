package com.danielxavierr.workshopmongo.config;
...
import com.danielxavierr.workshopmongo.dto.AuthorDTO;
import com.danielxavierr.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("21/03/2021"), new AuthorDTO(alex));
